...
onMounted(() => {
  ...
  cdnScript.src = '/_nuxt/assets/js/twikoo.all.min.js' // 使用相对路径
  //cdnScript.src = 'https://cdn.jsdelivr.net/npm/twikoo@1.6.39/dist/twikoo.all.min.js' // 使用相对路径
  ...
  const loadSecondScript = () => {
    ...
    initScript.innerHTML = `
      twikoo.init({
        envId: "https://twikoo.jwyt.cloud",
        el: '#twikoo-comment'
      });
    `
    initScript.id = 'twikoo' // 添加唯一的 ID
